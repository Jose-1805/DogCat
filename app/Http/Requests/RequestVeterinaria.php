...
class RequestVeterinaria extends FormRequest
{
    /**
    ...
    public function rules()
    {
        $data = [
            ...
            //datos de ubicacion veterinaria
            'ciudad_veterinaria'=>'required|exists:ciudades,id',
            'barrio_veterinaria'=>'required|max:255',
            'calle_veterinaria'=>'required_without_all:carrera_veterinaria,transversal_veterinaria|max:20',
            'carrera_veterinaria'=>'required_without_all:calle_veterinaria,transversal_veterinaria|max:20',
            'transversal_veterinaria'=>'required_without_all:calle_veterinaria,carrera_veterinaria|max:20',
            ...
            'telefono_administrador'=>'max:15',
            'celular_administrador'=>'required|max:15',
            ...
            'calle_administrador'=>'required_without_all:carrera_administrador,transversal_administrador|max:20',
            'carrera_administrador'=>'required_without_all:calle_administrador,transversal_administrador|max:20',
            'transversal_administrador'=>'required_without_all:calle_administrador,carrera_administrador|max:20',
        ...
        if($this->has('veterinaria')){
            $veterinaria = Veterinaria::find($this->input('veterinaria'));
    ...
    public function messages(){
        return[
            ...
            //datos basicos veterinaria
            'nit.required'=>'El campo nit, en la información básica de la veterinaria, es obligatorio.',
            'nit.max'=>'El campo nit, en la información básica de la veterinaria, puede contener máximo 20 caracteres.',
            'nit.unique'=>'El campo nit, en la información básica de la veterinaria, ya está en uso.',

            'nombres.required'=>'El campo nombres, en la información básica de la veterinaria, es obligatorio.',
            'nombres.mas'=>'El campo nombres, en la información básica de la veterinaria, puede contener máximo 200 caracteres.',

            'correo.required'=>'El campo correo, en la información básica de la veterinaria, es obligatorio.',
            'correo.email'=>'El campo correo, en la información básica de la veterinaria, no contiene el formato correcto.',
            'correo.max'=>'El campo correo, en la información básica de la veterinaria, puede contener máximo 250 caracteres.',

            'telefono.required'=>'El campo teléfono, en la información básica de la veterinaria, es obligatorio.',
            'telefono.max'=>'El campo teléfono, en la información básica de la veterinaria, puede contener máximo 20 caracteres.',
            'telefono.numeric'=>'El campo teléfono, en la información básica de la veterinaria, debe ser numérico.',

            'web_site.required'=>'El campo web site, en la información básica de la veterinaria, es obligatorio.',
            'web_site.max'=>'El campo web site, en la información básica de la veterinaria, puede contener máximo 250 caracteres.',
            'web_site.url'=>'El campo web site, en la información básica de la veterinaria, no contiene una url correcta.',

            'logo.file'=>'El campo logo, en la información básica de la veterinaria, es incorrecto.',
            'logo.mimes'=>'El campo logo, en la información básica de la veterinaria, debe pertenecer a uno de los formatos (jpeg,jpg o png).',
            'logo.max'=>'El campo logo, en la información básica de la veterinaria, es demasiado pesado (Máx. 500Kb).',


            //datos de ubicacion veterinaria
            'ciudad_veterinaria.required'=>'El campo ciudad, en la información de ubicación de la veterinaria, es obligatorio.',
            'ciudad_veterinaria.exists'=>'La información enviada es incorrecta.',

            'barrio_veterinaria.required'=>'El campo barrio, en la información de ubicación de la veterinaria, es obligatorio.',
            'barrio_veterinaria.max'=>'El campo barrio, en la información de ubicación de la veterinaria, puede contener máximo 255 caracteres.',

            'calle_veterinaria.required_without'=>'El campo calle, en la información de ubicación de la veterinaria, es obligatorio si no està el campo carrera.',
            'calle_veterinaria.max'=>'El campo calle, en la información de ubicación de la veterinaria, puede contener màximo 20 caracteres.',

            'carrera_veterinari.required_without'=>'El campo carrera, en la información de ubicación de la veterinaria, es obligatorio si no està el campo calle.',
            'carrera_veterinari.max'=>'El campo carrera, en la información de ubicación de la veterinaria, puede contener màximo 20 caracteres.',

            'numero_veterinaria.required'=>'El campo nùmero, en la información de ubicación de la veterinaria, es obligatorio.',
            'numero_veterinaria.max'=>'El campo nùmero, en la información de ubicación de la veterinaria, puede contener màximo 20 caracteres.',

            'especificaciones_veterinaria.max'=>'El campo especificaciones, en la información de ubicación de la veterinaria, puede contener màximo 255 caracteres.',
            ...
            'celular_administrador.required'=>'El campo celular, en los datos personales del administrador, es obligatorio',
            'celular_administrador.max'=>'El campo celular, en los datos personales del administrador, puede contener màximo 15 dìgitos',
            'celular_administrador.numeric'=>'El campo celular, en los datos personales del administrador, debe ser numèrico',
