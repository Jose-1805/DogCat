...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link href="{{asset('css/bienvenido.css')}}" rel="stylesheet" type="text/css">
        <link href="{{asset('j1805_slide/j1805_slide.css')}}" rel="stylesheet" type="text/css">
        <style>
            .view {
                background: url("{{asset('imagenes/sistema/background_dog.jpg')}}")no-repeat center center;
    ...
    <body>
        ...
        <div class="col-12 no-padding">
            <div class="row" id="contenedor-intro">
                <div class="col-12 no-padding">
                    @include('layouts.menus.bienvenido')
                </div>
            </div>
            <div class="row d-none" id="contenedor-contenido-general">
                <a class="btn btn-teal btn-mostrar-menu-fixed d-md-none">
                    <img src="{{asset('imagenes/sistema/dogcat_xs.png')}}" class="img-fluid margin-right-10" style="height: 30px;">
                ...
                <div id="contenedor-global-menu-fixed" class="d-none d-md-block col-11 col-md-4 col-lg-3 col-xl-2 no-padding teal darken-2" style="opacity: 0;">
                    @include('layouts.menus.menu_fixed')
                </div>
                ...
                <div id="contenedor-global-contenido" class="col-12 col-md-8 col-lg-9 col-xl-10 no-padding">
                    ...
                    <div id="servicios" class="container-fluid no-padding transparent padding-bottom-50 padding-top-50" >
                        @include('bienvenido.servicios')
                    </div>

                    <div id="precios" class="container-fluid transparent padding-bottom-50 padding-top-50" style="/*background-image: url({{asset('imagenes/sistema/background_perro.jpg')}});background-repeat: no-repeat;background-size: 100% auto;*/">
                        @include('bienvenido.precios')
                    </div>

                    <div id="quienes_somos" class="container-fluid text-center transparent padding-bottom-50 padding-top-50" >
                        @include('bienvenido.quienes_somos')
                    </div>

                    <div id="asociaciones" class="container-fluid transparent padding-bottom-50 padding-top-50" style="/*background-image: url({{asset('imagenes/sistema/background_perro.jpg')}});background-repeat: no-repeat;background-size: 100% auto;*/">
                        @include('bienvenido.alianzas')
                    </div>

                    <!--<div class="container-fluid no-padding">
                        <img style="width: 100%;" src="{{asset('imagenes/sistema/donaciones.jpg')}}">
                        ...
                        <div class="col-12 text-right" style="">
                            <img style="height: 150px;" src="{{asset('imagenes/sistema/alianzas/comedog.png')}}">
                        </div>
                    </div>-->
    ...
    @section('js')
        ...
        <script src="{{asset('j1805_slide/j1805_slide.js')}}"></script>
