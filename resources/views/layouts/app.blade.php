...
<head>
    ...
    @section('css')
        ...
        <link href="{{asset('css/notificaciones.css')}}" rel="stylesheet" type="text/css">
        <link href="{{asset('bootstrap-tour-master/build/css/bootstrap-tour.css')}}" rel="stylesheet" type="text/css">
    @show
...
<body class="fuelux" id="body">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="myModalLabel"><i class="fas fa-sync-alt margin-right-10"></i>Actualización (v {{$actualizacion_pendiente->version}})</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            </div>
                                            <div class="modal-body padding-top-10">
                                                <p>{{$actualizacion_pendiente->mensaje}}</p>
                                            </div>
    ...
    @section('js')
        ...
        <script src="{{url('js/filter_colums_table.js')}}"></script>
        <script src="{{url('bootstrap-tour-master/build/js//bootstrap-tour.js')}}"></script>
        <script>
            $(function () {
    ...
    <script src="{{asset('firebase_messaging.js')}}"></script>
    @if(\Illuminate\Support\Facades\Auth::check())
        @if($actualizacion_pendiente)
            <script>
                $(function () {
