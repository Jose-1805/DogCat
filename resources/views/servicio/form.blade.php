...
?>
{!! Form::model($servicio,['id'=>'form-servicio','data-toggle'=>'validator']) !!}

    @include('layouts.alertas',['id_contenedor'=>'alertas-servicio'])

    {!! Form::hidden('servicio',$servicio->id,['id'=>'servicio']) !!}
    <div class="row padding-top-20">
        ...
        <div class="col col-md-4">
            <div class="md-form c-select">
                ...
                {!! Form::select('estado',['Activo'=>'Activo','Inactivo'=>'Inactivo'],null,['id'=>'estado','class'=>'form-control']) !!}
            </div>
        </div>

        <div class="col col-md-4">
            <div class="md-form c-select">
                {!! Form::label('entidad','Entidad',['class'=>'active']) !!}
                {!! Form::select('entidad',$entidades,$servicio->veterinaria_id,['id'=>'entidad','class'=>'form-control']) !!}
            </div>
        </div>
        ...
        <div class="col col-md-4" style="margin-top: -20px;">
            <div class="md-form">
                <label for="aplicable_perros">
                    {!! Form::checkbox('aplicable_perros','si',$servicio->aplicable_perros=='si'?true:false,['id'=>'aplicable_perros','class'=>'']) !!}
                    Aplicable a perros
                </label>
            </div>
            <div class="md-form">
                <label for="aplicable_gatos">
                    {!! Form::checkbox('aplicable_gatos','si',$servicio->aplicable_gatos=='si'?true:false,['id'=>'aplicable_gatos','class'=>'']) !!}
                    Aplicable a gatos
                </label>
            </div>
        </div>
        ...
        <div class="col col-md-4">
            <div class="md-form">
                {!! Form::label('duracion_1_10','Entre 0 y 10 KG') !!}
                {!! Form::text('duracion_1_10',null,['id'=>'duracion_1_10','class'=>'form-control num-int-positivo']) !!}
            </div>
        </div>

        <div class="col col-md-4">
            <div class="md-form">
                {!! Form::label('duracion_10_25','Entre 10 y 25 KG') !!}
                {!! Form::text('duracion_10_25',null,['id'=>'duracion_10_25','class'=>'form-control num-int-positivo']) !!}
            </div>
        </div>

        <div class="col col-md-4">
            <div class="md-form">
                {!! Form::label('duracion_mayor_25','Mayor a 25 KG') !!}
                {!! Form::text('duracion_mayor_25',null,['id'=>'duracion_mayor_25','class'=>'form-control num-int-positivo']) !!}
            </div>
        </div>

        @if($servicio->exists && !Auth::user()->esSuperadministrador())
        ...
        <div class="col col-md-5">
            <div class="md-form">
                ...
                {!! Form::text('valor',null,['id'=>'valor','class'=>'form-control num-int-positivo',$disabled_edicion]) !!}
            </div>
        </div>
        <div class="col col-md-7">
            <div class="md-form">
                {!! Form::label('descuento','Descuento ofrecido a DogCat (%)') !!}
                {!! Form::text('descuento',null,['id'=>'descuento','class'=>'form-control num-int-positivo',$disabled_edicion]) !!}
            </div>
        </div>
