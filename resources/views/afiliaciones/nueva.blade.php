...
@section('content')
    <div class="container-fluid white padding-50">
        <div class="row">
            ...
            {!! Form::open(['id'=>'form-afiliacion','class'=>'col-12']) !!}
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="md-form c-select">
                                    ...
                                    {!! Form::select('veterinaria',$veterinarias,$veterinaria_select,['id'=>'veterinaria','class'=>'form-control',$disabled]) !!}
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="md-form c-select">
                    ...
                    <div class="row padding-top-20">
                        <div class="col-md-4 no-padding">
                            <div class="col">
                                <div class="md-form c-select">
                                    {!! Form::label('estado','Estado de pago',['class'=>'active']) !!}
                            ...
                            <div id="datos_pago" class="d-none">
                                ...
                                <div class="col">
                                    <div class="md-form c-select margin-top-50">
                                        {!! Form::label('numero_factura','Nº factura',['class'=>'active']) !!}
