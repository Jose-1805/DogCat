...
@endif
btn-navegacion-toggle-render margin-right-10" data-element="datos_basicos_veterinaria"><i class="fa fa-list-alt margin-right-5"></i>Datos básicos entidad</a>

<a href="#!" class="
@if(isset($except) && in_array('ubicacion_veterinaria',$except))
    teal-text text-lighten-2
@endif
btn-navegacion-toggle-render margin-right-10" data-element="ubicacion_veterinaria"><i class="fa fa-map-marker margin-right-5"></i>Ubicación entidad</a>
