...
<div class="contenedor-toggle-render" id="datos_basicos_veterinaria">
    ...
    <div class="col-12 padding-bottom-30 padding-left-none padding-right-none">
        @include('entidad.forms.navegacion',['except'=>['datos_basicos_veterinaria']])
    </div>
    @include('entidad.forms.datos_basicos_veterinaria')
...
<div class="contenedor-toggle-render d-none" id="ubicacion_veterinaria">
    ...
    <div class="col-12 padding-bottom-30 padding-left-none padding-right-none">
        @include('entidad.forms.navegacion',['except'=>['ubicacion_veterinaria']])
    </div>
    @include('entidad.forms.datos_ubicacion_veterinaria')
    <div class="col-12 text-right margin-top-30 no-padding">
...
<div class="contenedor-toggle-render d-none" id="datos_personales_administrador">
    ...
    <div class="col-12 padding-bottom-30 padding-left-none padding-right-none">
        @include('entidad.forms.navegacion',['except'=>['datos_personales_administrador']])
    </div>
    @include('entidad.forms.datos_personales_administrador')
...
<div class="contenedor-toggle-render d-none" id="datos_ubicacion_administrador">
    ...
    <div class="col-12 padding-bottom-30 padding-left-none padding-right-none">
        @include('entidad.forms.navegacion',['except'=>['datos_ubicacion_administrador']])
    </div>
    @include('entidad.forms.datos_ubicacion_administrador')
    <div class="col-12 text-right margin-top-30 no-padding">
