        ...
        <div class="row">
            ...
            <div class="col-12 no-padding">
                @if(Auth::user()->tieneFuncion($identificador_modulo, 'crear', $privilegio_superadministrador))
                    <a href="{{url('/veterinaria/crear')}}" class="btn btn-primary right margin-right-none"><i class="fa fa-plus-circle margin-right-10"></i>Nueva veterinaria</a>
                @endif
            </div>
...
@section('js')
    @parent
    <script src="{{asset('js/veterinaria/index.js')}}"></script>
    <script>
