        ...
        <div class="row">
            ...
            <div class="col-12 no-padding text-right">
                @if(Auth::user()->tieneFuncion($identificador_modulo, 'crear', $privilegio_superadministrador))
                    <a href="{{url('/afiliado/crear')}}"  class="btn btn-primary"><i class="fa fa-plus-circle margin-right-10"></i> Nuevo afiliado</a>
                @endif
                @include('layouts.componentes.btn_filter_table',['tabla'=>'tabla-usuarios'])
            </div>
            <div class="col-12 no-padding">
...
@section('js')
    @parent
    <script src="{{asset('js/afiliado/index.js')}}"></script>
    <script>
