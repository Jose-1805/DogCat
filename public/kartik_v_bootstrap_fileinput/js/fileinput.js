...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tMain1 = '{preview}\n' +
                '<div class="kv-upload-progress d-none"></div>\n' +
        ...
        _renderThumbProgress: function () {
            var self = this;
            return '<div class="file-thumb-progress d-none">' +
        ...
        lock: function () {
            ...
            self.disable();
            if (self.showRemove) {
                $h.addCss(self.$container.find('.fileinput-remove'), 'd-none');
            }
            if (self.showCancel) {
                self.$container.find('.fileinput-cancel').removeClass('d-none');
            }
        ...
        unlock: function (reset) {
            ...
            self.enable();
            if (self.showCancel) {
                $h.addCss(self.$container.find('.fileinput-cancel'), 'd-none');
            }
            if (self.showRemove) {
                self.$container.find('.fileinput-remove').removeClass('d-none');
            }
            if (reset) {
        ...
        upload: function () {
            ...
            self.$progress.removeClass('d-none');
            self.uploadCount = 0;
            self.uploadStatus = {};
            self.uploadLog = [];
            self.lock();
    ...
    $.fn.fileinput = function (option) {
        ...
        this.each(function () {
            ...
            if (!data) {
                ...
                opt = $.extend(true, {}, $.fn.fileinput.defaults, t, $.fn.fileinputLocales.es, l, options, self.data());
