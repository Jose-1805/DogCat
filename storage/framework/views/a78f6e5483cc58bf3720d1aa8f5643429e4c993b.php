...
<div class="contenedor-toggle-render" id="datos_basicos_veterinaria">
    <p class="titulo_principal margin-bottom-20 margin-top-20 col-12">Datos básicos - entidad</p>
...
<div class="contenedor-toggle-render d-none" id="ubicacion_veterinaria">
    <p class="titulo_principal margin-bottom-20 margin-top-20 col-12">Ubicación - entidad</p>
    <div class="col-12 padding-bottom-30">
