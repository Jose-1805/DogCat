<?php $__env->startSection('content'); ?>
    <div class="container-fluid white padding-50">
        <div class="row">
            <p class="titulo_principal margin-bottom-20">Veterinarias</p>
            <div class="contenedor-opciones-vista-fixed">
                <?php if(Auth::user()->tieneFuncion($identificador_modulo, 'crear', $privilegio_superadministrador)): ?>
                    <a href="<?php echo e(url('/veterinaria/crear')); ?>" class="btn btn-primary btn-circle wow fadeInLeftBig" data-toggle="tooltip" data-placement="right" title="Nueva veterinaria"><i class="fa fa-plus"></i></a>
                <?php endif; ?>
            </div>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Desactivar una veterinaria bloqueará todas las funcionalidades relacionadas con la misma.</p>
                    <p>¿Está seguro de desactivar la veterinaria seleccionada?</p>
                </div>
    ...
    <div class="modal fade" id="modal-activar-veterinaria" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Activar una veterinaria activará todas las funcionalidades relacionadas con la misma</p>
                    <p>¿Está seguro de activar la veterinaria seleccionada?</p>
                </div>
                <div class="modal-footer">
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('js/veterinaria/index.js')); ?>"></script>
    <script>
