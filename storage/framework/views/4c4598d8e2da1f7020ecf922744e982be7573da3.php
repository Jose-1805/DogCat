...
<?php echo Form::model($usuario,['id'=>'form-usuario','data-toggle'=>'validator']); ?>
    ...
    <div class="col-12">
        <?php echo $__env->make('afiliado.datos_personales', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <p class="titulo_principal margin-bottom-20 margin-top-20 col-12">Datos de ubicación</p>
    <div class="col-12">
        <?php echo $__env->make('afiliado.datos_ubicacion', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
