        ...
        <div class="col-6 col-md-4 col-lg-3 padding-5">
            <div class="col-12 border hoverable cursor_pointer no-padding item-select-img" data-value="<?php echo e($mascota->id); ?>">
                ...
                <?php else: ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <p class="col-12 text-center font-small nombre_mascota"><?php echo e($mascota->raza->tipoMascota->nombre.': '.$mascota->nombre); ?></p>
                <p class="col-12 text-center font-small" style="margin-top: -20px !important;"><?php echo e($mascota->strDataEdad()); ?></p>
            </div>
        </div>
