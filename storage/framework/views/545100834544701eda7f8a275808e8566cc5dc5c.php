    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body padding-top-20">
                <?php echo Form::open(['id'=>'form-veterinarias']); ?>

                <div class="md-form c-select <?php if(Auth::user()->getTipoUsuario() != 'personal dogcat'): ?> d-none <?php endif; ?>">
                    <?php echo Form::label('veterinaria','Veterinaria',['class'=>'active']); ?>

                    <?php echo Form::select('veterinaria',$veterinarias,null,['id'=>'veterinaria','class'=>'form-control']); ?>

                </div>
                <div class="md-form c-select margin-top-40 <?php if(Auth::user()->getTipoUsuario() != 'personal dogcat' && Auth::user()->getTipoUsuario() != 'empleado'): ?> d-none <?php endif; ?>">
                    <?php echo Form::label('usuario','Usuario',['class'=>'active']); ?>

                    <div id="contenedor-usuarios">
                        <?php echo Form::select('usuario',[''=>'Seleccione un usuario'],null,['id'=>'usuario','class'=>'form-control']); ?>

                    </div>
                </div>
                <div class="md-form c-select margin-top-40">
                    <?php echo Form::label('mascota','Mascota',['class'=>'active']); ?>

                    <div id="contenedor-mascotas">
                        <?php echo Form::select('mascota',[''=>'Seleccione una mascota'],null,['id'=>'mascota','class'=>'form-control']); ?>
...
<div class="modal fade" id="modal-cancelar-cita" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog padding-left-30 padding-right-30" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body padding-top-20">
                <?php echo Form::label('motivo_cancelacion','Motivo de cancelación'); ?>

                <?php echo Form::textarea('motivo_cancelacion',null,['id'=>'motivo_cancelacion','class'=>'md-textarea form-control','rows'=>'1']); ?>
...
<div class="modal fade" id="modal-registrar-pago" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog padding-left-30 padding-right-30" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body padding-top-20">
                <?php echo $__env->make('layouts.alertas',['id_contenedor'=>'alertas-pago'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['id'=>'form-registrar-pago','class'=>'']); ?>
                    ...
                    <div id="contenedor-valor-adicional" class="d-none margin-top-30">
                        <div class="md-form">
                            <?php echo Form::label('valor_adicional','Valor adicional'); ?>

                            <?php echo Form::text('valor_adicional',null,['id'=>'valor_adicional','class'=>'item-precio form-control num-int-positivo']); ?>

                        </div>

                        <div class="md-form">
                            <?php echo Form::label('descripcion_valor_adicional','Descripción del valor adicional'); ?>

                            <?php echo Form::textarea('descripcion_valor_adicional',null,['id'=>'descripcion_valor_adicional','class'=>'form-control md-textarea','maxlength'=>'250']); ?>
...
<div class="modal fade" id="modal-confirmar-cancelar-cita" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog padding-left-30 padding-right-30" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body padding-top-20">
                <p>Faltan menos de <?php echo e(config('params.horas_cancelacion_cita')); ?> horas para dar inicio a la cita.</p>
                <p>¿Está seguro de cancelar la cita seleccionada?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
...
<div class="modal fade" id="modal-finalizar-cita" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog padding-left-30 padding-right-30" role="document">
        <div class="modal-content">
            ...
            <?php echo $__env->make('layouts.alertas',['id_contenedor'=>'alertas-finalizar-cita'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <div class="modal-body padding-top-20">
                <?php echo Form::label('observaciones_cita','Observaciones'); ?>

                <?php echo Form::textarea('observaciones_cita',null,['id'=>'observaciones_cita','class'=>'md-textarea form-control','placeholder'=>'Ingrese las observaciones o resultados obtenidos durante la cita.']); ?>
