...
<div class="contenedor-toggle-render" id="datos_basicos_veterinaria">
    <h4 class="titulo_principal margin-bottom-20 margin-top-20 col-12">Datos básicos - entidad</h4>
    <div class="col-12 padding-bottom-30 padding-left-none padding-right-none">
        <?php echo $__env->make('entidad.forms.navegacion',['except'=>['datos_basicos_veterinaria']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <?php echo $__env->make('entidad.forms.datos_basicos_veterinaria', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<div class="contenedor-toggle-render d-none" id="ubicacion_veterinaria">
    <h4 class="titulo_principal margin-bottom-20 margin-top-20 col-12">Ubicación - entidad</h4>
    <div class="col-12 padding-bottom-30 padding-left-none padding-right-none">
        <?php echo $__env->make('entidad.forms.navegacion',['except'=>['ubicacion_veterinaria']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <?php echo $__env->make('entidad.forms.datos_ubicacion_veterinaria', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div class="col-12 text-right margin-top-30 no-padding">
...
<div class="contenedor-toggle-render d-none" id="datos_personales_administrador">
    ...
    <div class="col-12 padding-bottom-30 padding-left-none padding-right-none">
        <?php echo $__env->make('entidad.forms.navegacion',['except'=>['datos_personales_administrador']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <?php echo $__env->make('entidad.forms.datos_personales_administrador', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<div class="contenedor-toggle-render d-none" id="datos_ubicacion_administrador">
    ...
    <div class="col-12 padding-bottom-30 padding-left-none padding-right-none">
        <?php echo $__env->make('entidad.forms.navegacion',['except'=>['datos_ubicacion_administrador']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <?php echo $__env->make('entidad.forms.datos_ubicacion_administrador', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div class="col-12 text-right margin-top-30 no-padding">
...
<?php if(!$administrador->exists): ?>
    <div class="contenedor-toggle-render d-none row" id="seguridad_administrador">
        <div class="col-12">
