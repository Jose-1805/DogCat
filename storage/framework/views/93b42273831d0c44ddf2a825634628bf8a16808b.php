    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
            <div class="md-form">
                ...
                <?php echo Form::text('telefono_administrador',null,['id'=>'telefono_administrador','class'=>'form-control num-int-positivo','maxlength'=>'15']); ?>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="md-form">
                <?php echo Form::label('celular_administrador','N° Celular (*)'); ?>

                <?php echo Form::text('celular_administrador',null,['id'=>'celular_administrador','class'=>'form-control num-int-positivo','maxlength'=>'15']); ?>
