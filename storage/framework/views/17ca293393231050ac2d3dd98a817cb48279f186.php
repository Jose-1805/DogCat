...
<div class="row">
    ...
    <div class="col-md-6 col-lg-3">
        <div class="md-form">
            <?php echo Form::label('transversal-administrador','Transversal'); ?>

            <?php echo Form::text('transversal_administrador',$ubicacion_administrador->transversal,['id'=>'transversal-administrador','class'=>'form-control','maxlength'=>20]); ?>
    ...
    <div class="col-12">
        <div class="md-form">
            ...
            <?php echo Form::textarea('especificaciones_administrador',$ubicacion_administrador->especificaciones,['id'=>'especificaciones-administrador','class'=>'form-control md-textarea','maxlength'=>255]); ?>
