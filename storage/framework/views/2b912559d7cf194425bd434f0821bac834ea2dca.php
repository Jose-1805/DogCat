...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid white padding-50">
        <div class="row">
            <h3 class="titulo_principal margin-bottom-20">Editar veterinaria</h3>
            <?php echo $__env->make('veterinaria.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('js/veterinaria/editar.js')); ?>"></script>
    <script>
        $(function () {
            $("#imagen").fileinput(
                {
