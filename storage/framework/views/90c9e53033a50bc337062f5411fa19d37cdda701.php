...
<head>
    ...
    <title><?php echo e(config('app.name', 'Dogcat')); ?> - Términos y condiciones</title>
    ...
    <div id="contenido-pagina" class="container-fluid margin-bottom-50">
        <div class="row">
            <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 white">
                <div class="col-12">
                    <p class="titulo_principal font-weight-500">TÉRMINOS Y CONDICIONES DOGCAT</p>
                </div>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(url('js/terminos_condiciones.js')); ?>"></script>
<?php echo $__env->yieldSection(); ?>
</body>
</html>
