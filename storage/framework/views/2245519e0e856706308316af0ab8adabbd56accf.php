<?php if(Request::is('password') || Request::is('password/*') || Request::is('simulador-afiliacion')): ?>
    <li class="nav-item">
        <a id="btn-inicio" class="nav-link" href="<?php echo e(url('/')); ?>">
...
<?php elseif(Request::is('login')): ?>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('/password/reset')); ?>">
...
<?php else: ?>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(url('/simulador-afiliacion')); ?>">
            <div class="d-inline-flex justify-content-center" style="width: 25px;"><i class="fas fa-paw margin-right-10"></i></div>
