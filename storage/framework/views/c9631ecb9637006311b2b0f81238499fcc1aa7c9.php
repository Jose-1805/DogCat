            ...
            <?php if(Auth::user()->esSuperadministrador()): ?>
                <div class="col-md-6 col-lg-4">
                    <div class="md-form c-select">
                        ...
                        <?php echo Form::select('rol',\DogCat\Models\Rol::permitidos()->where('afiliados','no')->where('veterinarias','no')->where('registros','no')->pluck('nombre','id'),$usuario->rol_id,['id'=>'rol','class'=>'form-control']); ?>
