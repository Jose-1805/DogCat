...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid white padding-50">
        <div class="row">
            <h3 class="col-12 titulo_principal margin-bottom-20">Historial registro <strong class="teal-text text-lighten-2"><?php echo e($registro->nombre.' '.($registro->veterinaria == 'si'?'- Veterinaria':'')); ?></strong></h3>
            ...
            <div class="col-12 grey lighten-5 margin-bottom-10 padding-10">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <p><?php echo e($registro->direccion.' B/'.$registro->barrio); ?></p>
                    </div>
                    <div class="col-12">
                        <?php echo Form::label('asesor_asignado','Asesor asignado'); ?>

                        <?php if($registro->user_asignado_id): ?>
                            <p><?php echo e($registro->asesor->fullName()); ?></p>
                        <?php else: ?>
